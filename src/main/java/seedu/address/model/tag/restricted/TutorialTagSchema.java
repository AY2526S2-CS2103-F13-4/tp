...
public class TutorialTagSchema extends RegexTagSchema {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Tutorial tag expects format of an optional uppercase letter followed by maximum 2 numbers. Valid: 'D24' and '8'";
